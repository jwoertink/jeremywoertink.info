...
Game.start = function(mapData, x, y) {
  ...
  Game.viewport.x = x;
  Game.viewport.y = y;
  Game.tile.store(0, '/images/tiles/tile_black.png');
  Game.tile.store(1, '/images/tiles/tile_grass.png');
  Game.tile.store(2, '/images/tiles/tile_rock.png');
	Game.tile.store(3, '/images/tiles/ladderdown.png');
	Game.tile.store(4, '/images/tiles/ladderup.png');
	Game.tile.store(5, '/images/tiles/cave.png');
	Game.tile.store(6, '/images/tiles/sign.png');
	Game.setMap(mapData);
	
	Game.player.store(0, '/images/characters/scientist/scientist_n0.png');
	Game.player.store(1, '/images/characters/scientist/scientist_n1.png');
	Game.player.store(2, '/images/characters/scientist/scientist_n2.png');
	Game.player.store(3, '/images/characters/scientist/scientist_e0.png');
	Game.player.store(4, '/images/characters/scientist/scientist_e1.png');
	Game.player.store(5, '/images/characters/scientist/scientist_e2.png');
	Game.player.store(6, '/images/characters/scientist/scientist_s0.png');
	Game.player.store(7, '/images/characters/scientist/scientist_s1.png');
	Game.player.store(8, '/images/characters/scientist/scientist_s2.png');
	Game.player.store(9, '/images/characters/scientist/scientist_w0.png');
	Game.player.store(10,'/images/characters/scientist/scientist_w1.png');
	Game.player.store(11,'/images/characters/scientist/scientist_w2.png');
